...
type ApplyContentProps = {
  jobs: { slug: string; title: string; summary: string }[];
  resume: { accept: string; maxMb: number };
};

/** Application page body; ?job=<slug> preselects and titles the position. */
export function ApplyContent({ jobs, resume }: ApplyContentProps) {
